...
class ArcheryTeamData(models.Model):
...
def register_view(request):
  ...
  if request.method == 'POST':
    my_registration, created = ArcheryTeamData.objects.get_or_create(
  ...
  all_registrations = ArcheryTeamData.objects.filter(team=request.team)
  return render(request, 'hunt/special_puzzles/events/archery.html', {
      'data': [{
          'name': reg.name,
